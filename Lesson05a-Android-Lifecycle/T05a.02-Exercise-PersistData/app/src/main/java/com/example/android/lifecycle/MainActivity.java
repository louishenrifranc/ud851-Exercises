...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String LIFECYCLE_CALLBACKS_TEXT_KEY = "callablack";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)) {
            mLifecycleDisplay.setText(savedInstanceState.getCharArray(LIFECYCLE_CALLBACKS_TEXT_KEY).toString());
        }
    ...
    public void onSaveInstanceState(Bundle outState, PersistableBundle outPersistentState) {
        ...
        outState.putCharArray(LIFECYCLE_CALLBACKS_TEXT_KEY, mLifecycleDisplay.toString().toCharArray());
    }
